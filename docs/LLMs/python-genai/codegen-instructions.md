...
**Official Local Documentation README:** [docs/python-genai/README.md](./README.md)

**Official Local Documentation:** [docs/python-genai/genai\_doc.md](./genai_doc.md) NOTE: This file is a very large markdown file, do not try to read or parse it all at once. Instead, search it for topics you are interested in.

**Official Web Documentation:** [ai.google.dev/gemini-api/docs](https://ai.google.dev/gemini-api/docs)
