...
OCR_IMAGE_MARGIN_PX = int(os.environ.get('OCR_IMAGE_MARGIN_PX', '30'))
...
SCHEMA_DEFAULT_NUM_SAMPLE_ROWS = 20
SCHEMA_DEFAULT_NUM_HEAD_ROWS = 1
SCHEMA_MODEL_ID = 'gpt-5.2'
SCHEMA_THINKING_LEVEL = 'MEDIUM'
SCHEMA_REQUEST_TIMEOUT = 300.0

# Analysis settings
ANALYSIS_MODEL_ID = 'gpt-5-mini'
...
TAG_DEDUP_CSV_FILENAME = 'analysis_deduped.csv'
TAG_DEDUP_MAPPINGS_FILENAME = 'mappings.json'
TAG_DEDUP_STREAM_CHUNK_SIZE = 500
